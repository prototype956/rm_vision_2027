...
class RoI : public abstract_roi::RoI {
 ...
 public:
   ...
   */
  inline void BigLastRoiRect(cv::RotatedRect _rect, float _width_big_num, float _height_big_num) {
    roi_armor_data_.last_roi_armor_rect.size.width = _rect.size.width * _width_big_num;
    roi_armor_data_.last_roi_armor_rect.size.height = _rect.size.height * _height_big_num;
  }
