...
PnP::PnP(std::string _camera_path, std::string _pnp_config_path) {
  ...
  fmt::print("[{}] Info, ptz_camera_x,y,z: {}, {}, {}\n", idntifier_green, pnp_config_.ptz_camera_x,
             pnp_config_.ptz_camera_y, pnp_config_.ptz_camera_z);

  fmt::print("[{}] Info, ptz_barrel_x,y: {}, {}\n", idntifier_green,
             pnp_config_.barrel_ptz_offset_x, pnp_config_.barrel_ptz_offset_y);

  fmt::print("[{}] Info, offset_armor_yaw,pitch: {}, {}\n", idntifier_green,
             pnp_config_.offset_armor_yaw, pnp_config_.offset_armor_pitch);
...
void PnP::solvePnP(int _ballet_speed, int _armor_type, cv::Mat& _src_img, cv::RotatedRect _rect) {
  ...
  cv::solvePnP(object_3d_, target_2d_, cameraMatrix_, distCoeffs_, rvec_, tvec_, false,
...
void PnP::solvePnP(int _ballet_speed, int _width, int _height, cv::Mat& _src_img,
...
void PnP::solvePnP(int _ballet_speed, int _armor_type, cv::Mat& _src_img,
