...
class PnP : public abstract_pnp::PnP {
 public:
   ...
   * @param _rect         目标旋转矩形
   */
  void solvePnP(int _ballet_speed, int _armor_type, cv::Mat& _src_img, cv::RotatedRect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _rect         目标外接矩形
   */
  void solvePnP(int _ballet_speed, int _armor_type, cv::Mat& _src_img, cv::Rect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _rect         目标旋转矩形
   */
  void solvePnP(int _ballet_speed, int _width, int _height, cv::Mat& _src_img,
   ...
   * @param _rect         目标外接矩形
   */
  void solvePnP(int _ballet_speed, int _width, int _height, cv::Mat& _src_img, cv::Rect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _rect         目标旋转矩形
   */
  void solvePnP(int _ballet_speed, int _armor_type, cv::RotatedRect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _rect         目标外接矩形
   */
  void solvePnP(int _ballet_speed, int _width, int _height, cv::RotatedRect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _rect         目标外接矩形
   */
  void solvePnP(int _ballet_speed, int _armor_type, cv::Rect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _rect         目标外接矩形
   */
  void solvePnP(int _ballet_speed, int _width, int _height, cv::Rect _rect);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _depth        目标深度
   */
  void solvePnP(int _ballet_speed, int _armor_type, cv::RotatedRect _rect, int _depth);
  /**
   * @brief 角度结算
   *
   * @param _ballet_speed 子弹速度
   ...
   * @param _depth        目标深度
   */
  void solvePnP(int _ballet_speed, int _armor_type, std::vector<cv::Point2f> _target_2d,
                int _depth);
  /**
   * @brief 角度结算
   *
   ...
   * @param _target_2d    目标 2d 点坐标
   */
  void solvePnP(int _ballet_speed, int _armor_type, cv::Mat& _src_img,
